...
// Page TopRatedMovies.js
// Cette page est la page filtre affichant les films les mieux notés de l'API The Movie Database
...
class TopRatedMovies extends React.Component {
  ...
  // On initialise la variable topRatedMovies pour récupérer les informations des films les mieux notés depuis l'api
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <div className="">
        ...
        {/* Titre principal */}
        <h3 className="movieTitlePage">Films les mieux notés</h3>
