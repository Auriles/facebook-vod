...
// Page UpComingMovies.js
// Cette page est la page filtre affichant les films arrivant prochainement de l'API The Movie Database
...
class UpcomingMovies extends React.Component {
  ...
  // On initialise la variable upComingMovies pour récupérer les informations des films arrivant prochainement depuis l'api
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <div className="">
        ...
        {/* Titre principal */}
        <h3 className="movieTitlePage">Les prochaines sorties</h3>
